...
class RqtCartesianController(Plugin):
    ...
    def __init__(self, context):
        ...
        ui_file = os.path.join(
            self.package_path, "share", "explorer_user_interfaces", "resource", "rqt_armcontrol.ui"
        )
        ...
        self.publisher_zero_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/zero_pressed", 1)
        self.publisher_zero_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/zero_released", 1)
        self.publisher_J1_zero_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J1_zero_pressed", 1)
        self.publisher_J1_zero_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J1_zero_released", 1)
        self.publisher_J2_zero_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J2_zero_pressed", 1)
        self.publisher_J2_zero_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J2_zero_released", 1)
        self.publisher_J3_zero_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J3_zero_pressed", 1)
        self.publisher_J3_zero_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J3_zero_released", 1)
        self.publisher_J4_zero_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J4_zero_pressed", 1)
        self.publisher_J4_zero_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J4_zero_released", 1)
        self.publisher_J5_zero_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J5_zero_pressed", 1)
        self.publisher_J5_zero_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J5_zero_released", 1)
        self.publisher_J6_zero_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J6_zero_pressed", 1)
        self.publisher_J6_zero_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/J6_zero_released", 1)
        self.publisher_home_pressed_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/home_pressed", 1)
        self.publisher_home_released_ = self._context.node.create_publisher(Bool, "/explorer_user_interfaces/rqt_armcontrol/home_released", 1)
