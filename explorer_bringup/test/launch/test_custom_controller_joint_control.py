...
def generate_test_description():
    ...
    launch_file_path = os.path.join(pkg_share, 'launch', 'custom_controller_joint_control.launch.py')
...
class TestProcessOutput(unittest.TestCase):
    ...
    def test_no_crashes(self, proc_info, proc_output):
        ...
        ## Cannot be tested: error almost on every exit
        # launch_testing.asserts.assertExitCodes(proc_info, process="rqt_jointcontrol")
        
        launch_testing.asserts.assertExitCodes(proc_info, process="robot_state_publisher")
        launch_testing.asserts.assertExitCodes(proc_info, process="joint_output_integrator")
