...
def generate_test_description():
    ...
    launch_inclusion = IncludeLaunchDescription(
        ...
        launch_arguments={'can_port': 'vcan0', 'gui': 'false', 'spacenav': 'false'}.items()
    )
...
class TestProcessOutput(unittest.TestCase):
    ...
    def test_no_crashes(self, proc_info, proc_output):
        ...
        launch_testing.asserts.assertExitCodes(proc_info, process="spawner", cmd_args=["forward_command_controller"])
