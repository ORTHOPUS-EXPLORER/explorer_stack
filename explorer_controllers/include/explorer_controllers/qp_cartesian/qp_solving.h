...
private:
  ...
  bool
    enable_movement_detection_global_; /*!< Enable/disable global movement detection to prevent drift when no user input */
  double
  ...
  void callback_control_frame_selection_(
    const explorer_msgs::msg::ControlFrameSelection::SharedPtr msg);
  void timer_callback_();
  void callback_x_init_(
    const std::shared_ptr<explorer_msgs::srv::Pose::Request> req,
    std::shared_ptr<explorer_msgs::srv::Pose::Response> res);
  void callback_q_init_(
    const std::shared_ptr<explorer_msgs::srv::Float64::Request> req,
