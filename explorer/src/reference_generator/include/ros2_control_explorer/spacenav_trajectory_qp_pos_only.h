...
#ifndef SPACENAV_TRAJECTORY_QP_POS_ONLY_H
#define SPACENAV_TRAJECTORY_QP_POS_ONLY_H
...
{
    class SpacenavTrajectoryQPPosOnly
    {
        public:
        SpacenavTrajectoryQPPosOnly(rclcpp::Node::SharedPtr n);
